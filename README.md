...
**Key Achievement:** Restricted unauthorized access to sensitive files and directories
...
**Key Achievement:** Identified after-hours failed logins and geographic access anomalies
...
- **Tools:** Linux CLI, chmod, Database querying
- **Security:** Access control, Log analysis, Incident response, Least privilege
- **Concepts:** Authentication, Authorization, Security hardening, Threat detection
